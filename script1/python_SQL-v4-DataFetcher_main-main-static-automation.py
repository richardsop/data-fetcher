            ...
            with open(dest_name, 'wb') as outfile:
                #for line in infile:
                    try:
                        ...
                        result_m = result[["StaticPrecisionOverlay.ValueX", "StaticPrecisionOverlay.ValueY", "EndTime.#text","MachineNumber.#text","MachineType.#text","Release.#text","StartTime.#text", "Status.#text", "TaskName.#text"]]
                        result_m = result_m.rename(index=str, columns={"StaticPrecisionOverlay.ValueX": "value_X",                                "StaticPrecisionOverlay.ValueY": "value_Y",                                "EndTime.#text": "endTime", "MachineNumber.#text": "machineNumber",                               "Release.#text": "release","MachineType.#text":"machineType",                               "StartTime.#text": "startTime",                                 "Status.#text": "status_mam",                               "TaskName.#text": "taskName"                               })
                        #print result_m
                        result_m.to_sql(name='ovl_staticPrecision', con=engine, if_exists = 'append', index=False)
                        outfile.write(line)
                    except Exception:
                        pass
